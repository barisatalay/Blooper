...
Tests/BlooperTests/
  MistakeTests.swift, MistakeLogTests.swift, MistakeStoreTests.swift, HookInstallerTests.swift, MarkdownExporterTests.swift
tests/scripts/
...
Expected: 6 pass, `0 failure(s)`, exit 0. (checker.sh henüz yok — setup'taki `|| true` bunu tolere eder.)
